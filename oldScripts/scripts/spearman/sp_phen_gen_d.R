...
i1$newcolumn<-paste(unique(w$Diet))
...
s1$newcolumn<-paste(unique(w$Diet))
...
write.csv(u4, "sp_z_n_rand_phen_d_s.csv")
write.csv(f4, "#sign_sp_z_rand_phen_d_s.csv")
write.csv(g4, "#sign_sp_z_all_rand_phen_d_s.csv")