...
ggplot(cbind(b, iris.lda.values$x),
  ...
  theme(text = element_text(size = 18))
### save
ggsave("disc_alld_zn_r_s_100.png", dpi = 100, width=25, height=25, units= c("cm"))
ggsave("disc_alld_zn_r_s_300.png", dpi = 300, width=25, height=25, units= c("cm")) 

# P NS
w1<-q[(q$DT=="PRNS"|q$DT=="PHFNS"|q$DT=="PHS11NS"),]
w<- w1[, -c(2:7) ]
b<- w[c(rep(TRUE, 1L), colSums(w[2L:ncol(w)]) > 1L)]
# linear discriminant
iris.lda <- lda(DT ~ ., data = b)
...
ggplot(cbind(b, iris.lda.values$x),
  ...
  theme(text = element_text(size = 18))
### save
ggsave("disc_alld_zn_p_ns_100.png", dpi = 100, width=25, height=25, units= c("cm"))
ggsave("disc_alld_zn_p_ns_300.png", dpi = 300, width=25, height=25, units= c("cm")) 

#PR S
w1<-q[(q$DT=="PRS"|q$DT=="PHFS"|q$DT=="PHS11S"),]
w<- w1[, -c(2:7) ]
b<- w[c(rep(TRUE, 1L), colSums(w[2L:ncol(w)]) > 1L)]
# linear discriminant
iris.lda <- lda(DT ~ ., data = b)
...
ggplot(cbind(b, iris.lda.values$x),
  ...
  theme(text = element_text(size = 18))
### save
ggsave("disc_alld_zn_p_s_100.png", dpi = 100, width=25, height=25, units= c("cm"))
ggsave("disc_alld_zn_p_s_300.png", dpi = 300, width=25, height=25, units= c("cm")) 


# PA
w1<-q[(q$DT=="PANS"|q$DT=="PHFANS"|q$DT=="PHSA11NS"|q$DT=="PHSA6NS"),]
w<- w1[, -c(2:7) ]
b<- w[c(rep(TRUE, 1L), colSums(w[2L:ncol(w)]) > 1L)]
# linear discriminant
iris.lda <- lda(DT ~ ., data = b)
...
ggplot(cbind(b, iris.lda.values$x),
  ...
  theme(text = element_text(size = 18))
### save
ggsave("disc_alld_zn_pa_ns_100.png", dpi = 100, width=25, height=25, units= c("cm"))
ggsave("disc_alld_zn_pa_ns_300.png", dpi = 300, width=25, height=25, units= c("cm")) 
...
ggplot(cbind(b, iris.lda.values$x),
  ...
  theme(text = element_text(size = 18))
### save
ggsave("disc_alld_zn_pa_s_100.png", dpi = 100, width=25, height=25, units= c("cm"))
ggsave("disc_alld_zn_pa_s_300.png", dpi = 300, width=25, height=25, units= c("cm")) 