...
### save
ggsave("disc_alld_zn_r_ns_300_pap_no_text.png", dpi = 300, width=25, height=25, units= c("cm")) 
...
ggplot(cbind(b, iris.lda.values$x),
  ...
  coord_cartesian(xlim = c(-3, 6))
### save
ggsave("disc_alld_zn_r_s_300_pap_no_text.png", dpi = 300, width=25, height=25, units= c("cm")) 
...
ggplot(cbind(b, iris.lda.values$x),
  ...
  coord_cartesian(xlim = c(-3, 6))
### save
ggsave("disc_alld_zn_p_ns_300_pap_no_text.png", dpi = 300, width=25, height=25, units= c("cm")) 
...
ggplot(cbind(b, iris.lda.values$x),
  ...
  coord_cartesian(xlim = c(-3, 6))
### save
ggsave("disc_alld_zn_p_s_300_pap_no_text.png", dpi = 300, width=25, height=25, units= c("cm")) 
...
### save
ggsave("disc_alld_zn_pa_ns_300_pap_no_text.png", dpi = 300, width=25, height=25, units= c("cm")) 
...
ggplot(cbind(b, iris.lda.values$x),
  ...
  coord_cartesian(xlim = c(-3, 8))
### save
ggsave("disc_alld_zn_pa_s_300_pap_no_text.png", dpi = 300, width=25, height=25, units= c("cm")) 