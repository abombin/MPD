...
write.csv(y1a, "qp_z_n_p_ad.csv")
write.csv(o4, "qp_#sign_z_n_p_ad.csv")
write.csv(u1, "qp_model_z_n_p_ad.csv")
...
write.csv(y1a, "qp_z_n_p_ag.csv")
write.csv(o4, "qp_#sign_z_n_p_ag.csv")
write.csv(u1, "qp_model_z_n_p_ag.csv")
...
write.csv(y1a, "qp_z_n_p_at.csv")
write.csv(o4, "qp_#sign_z_n_p_at.csv")
write.csv(u1, "qp_model_z_n_p_at.csv")
