...
write.csv(a3, "qp_z_n_hfhs_ad_s.csv")
write.csv(s3, "qp_#sign_z_n_hfhs_ad_s.csv")
write.csv(d3, "qp_model_z_n_hfhs_ad_s.csv")
...
write.csv(a3, "qp_z_n_hfhs_ag_s.csv")
write.csv(s3, "qp_#sign_z_n_hfhs_ag_s.csv")
write.csv(d3, "qp_model_z_n_hfhs_ag_s.csv")
...
write.csv(a3, "qp_z_n_hfhs_at_z.csv")
write.csv(s3, "qp_#sign_z_n_hfhs_at_z.csv")
write.csv(d3, "qp_model_z_n_hfhs_at_z.csv")
